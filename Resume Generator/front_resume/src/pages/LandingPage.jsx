        ...
        <div className="hero-content text-center">
          <div className="max-w-2xl">
            <h1 className="text-5xl font-bold">
              Leverage AI to create an appealing resume
            </h1>
            <p className="py-6 text-lg">
              Build a professional resume in moments. For people who don't wish to indulge in manually making their resumes because they are too busy juggling their balls. Get a job
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body outline">
                <p>
                  ...
                  professional and got me multiple interviews wow so naise!!!!!!!!!."
                </p>
                <div className="flex items-center mt-4">
                  ...
                  <div className="ml-4">
                    <h4 className="font-bold">Chad Bingham</h4>
            ...
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body outline">
                <p>
                  "This website so good I wanna nut"
                </p>
                <div className="flex items-center mt-4">
                  <div className="avatar">
                    <div className="w-12 rounded-full">
                  ...
                  <div className="ml-4">
                    <h4 className="font-bold">Sex_Jokes_Aren't_Funny_Why_Do_I_Make_Them</h4>
                    <p>Cognitive Behavioral Therapy Specialist</p>
                  </div>
                </div>
              </div>
            </div>
