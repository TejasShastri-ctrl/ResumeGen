...
import { generateResume } from "../apis/ResumeService";
...
const GenerateResume = () => {
  ...
  const template = searchParams.get("template") || "issue getting template param";
  ...
  const [showFormUI, setShowFormUI] = useState(true); //! False thevla hota mhanun itka issue zala
    ...
    return (
      <div>
        ...
        <div className="flex mt-5 justify-center gap-2">
          ...
          <div
            onClick={() => {
              setShowPromptInput(false); //wow
              setShowFormUI(true); //wow
              setShowResumeUI(false); //wow
            }}
